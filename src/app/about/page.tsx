  ...
  return (
    <div className="bg-[url('/images/about-page-background.webp')] bg-cover bg-center min-h-full">
      ...
      <p>
        ...
        specialize in creating user-friendly solutions that bring ideas to life.
        As a national mathematics and speedcubing champion, my problem-solving
        skills are matched by a knack for precision and speed—qualities I now
        channel into delivering high-quality code and innovative designs.
      </p>
      <br />
      <br />
      ...
      <ul>
        ...
        <li>D3.js: Visualizing complex data with custom, interactive charts</li>
        <li>Chart.js and Recharts: Creating intuitive data visualizations</li>
        <li>
          MongoDB: Working with NoSQL databases for scalable backend integration
        </li>
        <li>
          Microsoft Azure: Deploying and managing applications in the cloud.
        </li>
        <li>
          Testing Tools: Writing unit and integration tests using React Testing
          Library (RTL), Jest and Vitest to ensure code quality and reliability
        </li>
      </ul>
      <h2>Achievements</h2>
      <p>
        ...
        Competition (ANMC), Nigeria, in 2010, first place in Senior Mathematics
        at the National Mathematics and Science Olympiad, Nigeria, in 2016,
        first place in the Edu-Learn ARIS Ghana Championships 2020, and second
        place in the Nigeria Open 2019, where I set two national records.
      </p>
    </div>
  );
};
